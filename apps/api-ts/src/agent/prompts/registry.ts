...
const assets: readonly PromptAsset[] = [
  {
    ...
    allowedTools: ["get_player_summary", "get_match_list", "get_match_detail", "compare_attack_defense", "compare_map_performance", "find_round_evidence", "get_round_evidence"],
    forbiddenClaims: ["hidden MMR/ELO", "pre-match scouting", "real-time coaching", "cheat assistance"],
    budget: { maxSteps: 4, maxToolCalls: 3 },
    changelog: "Initial minimal analysis policy."
  },
  {
    ...
    budget: { maxSteps: 4, maxToolCalls: 3 },
    changelog: "Initial minimal supervisor prompt."
  }
];
